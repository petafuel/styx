...
public class ConsentResourceConsorsTest extends GetConsentResourceTest {
    ...
    public void A_createConsentTest() throws IOException {
        ...
        AccountReference accountReference = new AccountReference("DE60760300800500123456", AccountReference.Type.IBAN);
