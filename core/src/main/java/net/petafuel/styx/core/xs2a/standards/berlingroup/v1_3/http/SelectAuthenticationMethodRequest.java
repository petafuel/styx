...
public class SelectAuthenticationMethodRequest extends SCARequest {
    ...
    public SelectAuthenticationMethodRequest(PaymentService paymentService, PaymentProduct paymentProduct, String paymentId) {
        super(paymentService, paymentProduct, paymentId);
    }

    public SelectAuthenticationMethodRequest(String consentId) {
        super(consentId);
    }
