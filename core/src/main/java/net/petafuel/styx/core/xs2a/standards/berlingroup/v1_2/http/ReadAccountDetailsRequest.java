...
public class ReadAccountDetailsRequest extends AISRequest {
    public ReadAccountDetailsRequest(Consent consent, String consentId, String accountId, String transactionId) {
    ...
    public String getServicePath() {
        return String.format("/v1/accounts/%s", getAccountId());
    }
}
