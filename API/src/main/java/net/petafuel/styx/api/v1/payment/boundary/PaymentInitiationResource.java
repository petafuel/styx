...
public class PaymentInitiationResource extends RestResource {
    ...
    public Response initiateSinglePayment(@BeanParam PaymentTypeBean paymentTypeBean,
        ...
        XS2APaymentRequest aspspRequest = new PaymentInitiationProvider(getXS2AStandard(), paymentTypeBean, getPsu()).buildSinglePaymentRequest(singlePaymentBody);
    ...
    public Response initiateBulkPayment(
        ...
        XS2APaymentRequest aspspRequest = new PaymentInitiationProvider(getXS2AStandard(), paymentTypeBean, getPsu()).buildBulkPaymentRequest(bulkPaymentBody);
        aspspRequest.setTppRedirectPreferred(getRedirectPreferred());
        aspspRequest.getHeaders().putAll(getAdditionalHeaders());
        InitiatedPayment initiatedPayment = getXS2AStandard().getPis().initiatePayment(aspspRequest);
        PaymentResponse paymentResponse = new PaymentResponse(initiatedPayment);
    ...
    public Response initiatePeriodicPayment(@BeanParam PaymentTypeBean paymentTypeBean,
        ...
        XS2APaymentRequest aspspRequest = new PaymentInitiationProvider(getXS2AStandard(), paymentTypeBean, getPsu()).buildPeriodicPaymentRequest(periodicPaymentBody);
        aspspRequest.setTppRedirectPreferred(getRedirectPreferred());
        aspspRequest.getHeaders().putAll(getAdditionalHeaders());
        InitiatedPayment initiatedPayment = getXS2AStandard().getPis().initiatePayment(aspspRequest);
        PaymentResponse paymentResponse = new PaymentResponse(initiatedPayment);
