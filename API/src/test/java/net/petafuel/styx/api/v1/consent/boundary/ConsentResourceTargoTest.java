...
public class ConsentResourceTargoTest extends GetConsentResourceTest {
    ...
    public void A_createConsentTest() throws IOException {
        ...
        AccountReference accountReference = new AccountReference("DE70300209005320320678", AccountReference.Type.IBAN);
